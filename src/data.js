export const warm_palces = [
  {
    ...
    best_things_to_do: ["Sightseeing", "Visiting temples", "Boating"],
  ...
  },
  {
    ...
    best_things_to_do: ["Camping", "Desert Safari"],
    best_time_to_visit: "October to March",
    how_to_reach:
...
export const national_parks = [
  {
    ...
    descripton:
      "The Ranthambore National Park is a paradise for adventure seeking families. Filled with an exotic range of flora and fauna, the park is known for housing the endangered Bengal Tiger. It also has many other attractions located within its boundaries that add to the flavor of exploring the park",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/11/Ranthambore-National-Park_27th-nov.jpeg",
    images: [],
    major_tourist_attractions: [
      "Ranthambore Fort",
      "Padam Talab",
    ...
    how_to_reach:
      "Sanganer Airport in Jaipur is the nearest one located 180 km away",
    places_to_stay: [
    ...
    tips_to_remember:
      "The park is closed between the months of July to September. Plan your trip accordingly",
  },
  {
    id: "13",
    name: "Periyar National Park, Kerala",
    descripton:
      "The Periyar National Park is a fine place to go on a safari with family as you can spend endless amounts of time with nature. The cities and their bustles are faraway from Periyar as the tigers and an exotic collection of flora and fauna acquaint your vacay",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2020/01/Bhandardara_21st-Jan1.jpg",
    images: [],
    major_tourist_attractions: [
      "Suruli Falls",
    ...
    best_things_to_do: [
      ...
      "go boating on the Periyar Lake",
    ],
    best_time_to_visit: "September to April",
    how_to_reach:
      "Madurai International Airport is the closest to the Park, 136 km away",
    ...
    tips_to_remember:
      "Avoid attention of wild animals by wear earthy tones like brown and green",
  },
  {
    id: "14",
    ...
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/01/Jim-Corbett-National-Park-aman.jpg",
    images: [],
    major_tourist_attractions: [
      "Garjiya Devi Temple",
    ...
    best_time_to_visit: "November to February",
    how_to_reach:
      "The best way to reach Jim Corbett National Park is by taking a train to Ramnagar. There are direct trains from Delhi that connects with Ramnagar. From there, Jim Corbett is just a kilometer away",
    places_to_stay: [
    ...
    places_to_eat: [
      "Mudhouse Under Mangoes",
      "Barbeque Bay",
      "Kundan’s",
      "Doabas Punjabi Dhaba",
    ],
    tips_to_remember:
      "Ensure to have all the required permits to enter the park",
  },
];
...
export const heritage_city = [
  {
    ...
    descripton:
      "Hampi is not just a top family but one of the best travel destinations in India as well. It is located on the banks of river Tunga and has a UNESCO recognized World Heritage Site. The ruins of Hampi and other major attractions will definitely allow you to have a great time with your family",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2020/04/Hampi-Karnataka_29th-Apr.jpg",
    images: [],
    major_tourist_attractions: [
    ...
    best_things_to_do: [
      "Explore the historic and cultural attractions",
      "visit the giant boulders of Hampi",
      "boating and fishing at the Tunga river",
    ],
    best_time_to_visit: "November to March",
  ...
  },
  {
    ...
    descripton:
      "Agra, the city famous for its architectural wonder, the Taj Mahal, is another one of the best family vacation destinations in India that you can visit. It is a weekend getaway from Delhi and makes for an ideal vacation spot. The Taj Mahal is one monument that you should definitely visit in your lifetime. Other than that there is the Agra Fort that one should explore, and also the red sandstone city of Fatehpur Sikri.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/03/The-Taj-Mahal-woman-cover.jpg",
    images: [],
    major_tourist_attractions: ["Taj Mahal", "Fatehpur Sikri", "Agra Fort"],
    best_things_to_do: [
      "Explore the monuments",
      "Forts and Go shopping in the city",
    ],
    best_time_to_visit: "October to March",
    how_to_reach:
      "You can easily take a road trip from Delhi to Agra via six-lane Yamuna Expressway. There are direct buses running between Delhi and Agra as well. If you like train journeys, you could also choose to travel by train",
    places_to_stay: [
      "Radisson Hotel Agra",
      "Hotel Taj Resorts",
      "Courtyard Agra",
    ...
    tips_to_remember:
      "Visit the Taj Mahal early in the morning to avoid the crowd",
  },
  {
    id: "20",
    name: "Udaipur, Rajasthan",
...
export const natural_city = [
  {
    ...
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/10/shutterstock_569073934.jpg",
    images: [],
    major_tourist_attractions: [
      "Jakhoo Temple",
      "The Ridge",
    ...
    how_to_reach:
      "The most convenient way to reach Shimla from Delhi is by driving in your own car. You could aslo board one of the overnight volvo buses from New Delhi. If you want to experience the ride on toy train, then you will have to begin from Chandigarh.",
    places_to_stay: [
    ...
    tips_to_remember:
      "Carry enough cash as there are connectivity issues in the hill",
  },
  {
    id: "23",
    name: "Nainital, Uttarakhand",
    descripton:
      "Set around a shimmering lake, Nainital is one of the top ten holiday destinations in India which serves Indian families as the best place to spend the summers at. With so many fun things to do in Nainital like that of cable car ride, and boating at the Nainital Lake, your trip to this paradise is sure to be a hit",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/10/shutterstock_565402126.jpg",
    images: [],
    major_tourist_attractions: [
      "Nainital Zoo",
      "Naini Peak",
    ...
    best_things_to_do: [
      ...
      "Trek to the Tiffin Top and Birdwatching at Sattal",
    ],
    best_time_to_visit: "April to June and September to October",
    how_to_reach:
      "You can take a train or bus till kathgodam. From here, you will find many private and shared taxis that will take you to Nainital. A private cab will cost you around INR 700-800 if you bargain well.",
    places_to_stay: [
      "The Naini Retreat",
...

  {
    ...
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/10/shutterstock_476043799.jpg",
    images: [],
    major_tourist_attractions: [
      "Batasia Loop",
    ...
    best_things_to_do: [
      "Enjoy a ride in the toy train",
      "Explore the monasteries at Mirik and Camping at the Tiger Hill",
    ],
    best_time_to_visit: "October to March",
    how_to_reach:
      "Bagdogra Airport is just 94 km away from Darjeeling that takes about 3 hours by car to cover. New Jalpaigudi is the nearest railway station to Darjeeling, 64 km.",
    places_to_stay: [
      "Mayfair Darjeeling",
  ...
  },
  {
    ...
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/10/shutterstock_228041755.jpg",
    images: [],
    major_tourist_attractions: [
    ...
    best_things_to_do: [
      ...
      " Camping at Avalanche Lake and Try the homemade chocolates",
    ...
    tips_to_remember:
      " If you’re planning to take the train ride, book your tickets in advance",
  },
  {
    id: "26",
    name: "Dharamshala, Himachal Pradesh",
    descripton:
      "Located in the hills of Himachal Pradesh, this is one of the summer family holiday destinations in India. An overnight journey from Delhi, it also makes for an amazing weekend getaway. The views of the mountains are stunning and the environs are peaceful. If your family is game to it, then you can also set up tents and stay overnight. Explore the monasteries and relish the local flavours of this hill town.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/08/Trekking-near-Kareri-Lake-one-of-top-things-to-do-in-Dharamshala-ss0108217.jpg",
    images: [],
    major_tourist_attractions: [
      "Namgyal Monastery",
      " Kareri Dal Lake and Dharamshala Cricket Stadium",
    ],
    best_things_to_do: [
      "Visit the Kangra Fort and Head to St. John In The Wilderness Church",
    ],
    best_time_to_visit: "March to July",
    how_to_reach:
      "Take an overnight volvo bus from New Delhi to Dharamshala. Gaggal Airport is just 13 km away from Dharamshala. You can take a private taxi from the airport to Dharamshala.",
  ...
  },
  {
    ...
    major_tourist_attractions: [
      ...
      "Ward’s Lake",
      "Mawsynram",
      "Lady Hydari Park and Don Bosco Museum",
    ],
    best_things_to_do: [
      "Admire the Umiam Lake",
      "Be charmed by the Elephant Falls",
      "Explore the root bridge at Mawlynnong",
    ],
    best_time_to_visit: "September to May",
    how_to_reach:
      "You could take a flight to Shillong. The nearest airport is Umroi Airport in Barapani. You would have to take a cab from the airport. The frequency of flighst between New Delhi ans Shillong is quite low. So, do check in advance while booking your tickets.",
    places_to_stay: [
  ...
  },
  {
    ...
    major_tourist_attractions: [
      ...
      "Ganesh Tok",
      "Ban Jhakri Falls",
      "Tinkitam Rayong and Do Drul Chorten",
    ],
    best_things_to_do: [
      "Visit the highest motorable road of Nathu La Pass",
      "Shopping at MG Road",
      " Visit the 200-year old Enchey Monastery",
    ],
    best_time_to_visit: "September to June",
    how_to_reach:
      "Take a flight to Bagdogra Airport, 125 km away from Gangtok. You will have to hire a private taxi from the airport. It is going to be a long and bumpy ride.",
    places_to_stay: [
    ...
    tips_to_remember:
      "Carry your travel documents and drink sealed water to avoid contamination",
  },
  {
    id: "29",
    ...
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2020/01/Cover-Image-of-Places-to-Visit-in-Mussoorie_22nd-Jan.jpg",
    images: [],
    major_tourist_attractions: [
      "Company Garden",
      "Camels Back Road",
    ...
    best_things_to_do: [
      "Try various adventure sports such as hiking",
      "trekking",
      " rock climbing",
      "engage in wine making",
      "go for wildlife safari",
    ],
    best_time_to_visit: "April to June",
    how_to_reach:
      " The best way to reach Mussoorie is by taking a train till Dehradun Railway Station that is around 36 km. From there, one can board local taxis or buses to cover the remaining distance.",
    places_to_stay: [
      "Mussoorie Gateway",
      "Seven Oaks",
      "Wildflower Cottage",
      "Amara The High Walls",
    ],
    famous_food: [
      "Tibetan cuisine",
      " rice bowl",
    ...
    tips_to_remember:
      "Avoid traveling during the monsoon season due to landslides",
  },
];
...
export const holy_places = [
  {
    ...
    descripton:
      "A mixture of everything, Rishikesh offers a sorted family holiday! May it be temples beside rivers or sports activities, it has so much in store that you will be left spoilt for choice. Start your day by visiting the famous temples, not to miss Lakshman Jhula, indulge in the adventures and end your day dining at one of the popular cafes. It is one of the family vacation destinations on a budget in India.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/01/Rishikesh-Uttarakhand.jpg",
    images: [],
    major_tourist_attractions: ["Lakshman Jhula", "Ram Jhula", "Triveni Ghat"],
    best_things_to_do: ["River rafting", " Bungee jumping", "Paragliding"],
    best_time_to_visit: "Anytime of the year",
    how_to_reach:
      " Jolly Grant Airport in Dehradun is jsut 35 km away from Rishikesh. You could alsto take a direct volvo bus from New Delhi to Rishikesh. There are a number of trains from New Delhi to Haridwar, half-an-hour drive to Rishikesh.",
  ...
  },
  {
    ...
    descripton:
      "Amritsar is the largest city in Punjab and is generally known for Golden Temple. It is one of the finest holiday destinations in India as it will also give you access to the fine food and culture of Punjab. The attractions that remind us of great Independence are also there in the city. ",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/01/Amritsar.jpg",
    images: [],
    major_tourist_attractions: [
      "Jallianwala Bagh",
      "Partition Museum",
    ...
    best_things_to_do: [
      "Watch the ceremonies at the ‘Berlin Wall of Asia’ or Wagah border",
      "eat amazing traditional food",
    ],
    best_time_to_visit: "November to March",
    how_to_reach:
      "Sri Guru Ram Das Jee International Airport in Amritsar is the main airport serving the city",
    places_to_stay: [
    ...
    tips_to_remember:
      " It is mandatory to cover your head while in the Golden Temple Gurdwara, so carry a scarf or a handkerchief.",
  },
  {
    id: "32",
    ...
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2020/09/Best-Time-To-Visit-Vaishno-Devi.jpg",
    images: [],
    major_tourist_attractions: [
    ...
    places_to_eat: [
      "Vaishno Devi Bhojanalay",
      "Pooja Vaishno Dhaba",
      "Sagar Ratna",
    ],
    tips_to_remember:
      "It is highly advisable to avoid the peak season for a comfortable darshan",
  },
  {
    id: "33",
    name: " Rameswaram, Tamil Nadu",
    descripton:
      "Rameswaram is a coastal town on Pamban Island in Tamil Nadu. As much as Rameswaram is famous for its temples and being a “Char Dham” – it is also a coastal paradise. The weather is fine on most days of the year and you can enjoy a great time with your family.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2020/01/best-time-to-visit-rameswaram.jpg",
    images: [],
    major_tourist_attractions: [
      "Agni Theertham",
      " Rameswaram Temple",
    ...
    best_time_to_visit: "October to April",
    how_to_reach:
      " Madurai Airport, 174 km away is the nearest airport to Rameswaram",
    places_to_stay: [
      "Hotel SS Grand",
    ...
    places_to_eat: [
      "Temple City Veg Family Restaurant",
      "Sri Murugan Mess",
      "Nellai Sri Madhura",
    ],
    tips_to_remember:
      "Know the rituals and understand the basics before entering the temples.",
  },
  {
    id: "34",
    name: "Tirupati, Andhra Pradesh",
    descripton:
      "This temple city in Andhra Pradesh is definitely worthy of a place in the list of top family destinations in India. Not just temples, the city also has hills and amazing views making it the perfect place for families to unwind themselves.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2020/02/Waterfalls-In-Tirupati_20th-feb.jpg",
    images: [],
    major_tourist_attractions: [
    ...
    best_things_to_do: [
      ...
      "explore the nature around and tour the lakes",
    ],
    best_time_to_visit: "November to March",
    how_to_reach:
      " Tirupati International Airport serves as the major link between the city and the world.",
    places_to_stay: [
      " Marasa Sarovar Premiere",
      "Holiday Inn Tirupati",
      "Tirupati Homestay",
    ],
    ...
    tips_to_remember:
      " Book your trip to the Tirupati temple darshan a month in advance, at least, to avoid last minute chaos",
  },
  {
    id: "35",
    name: "Mahabaleshwar, Maharashtra",
    descripton:
      "A hill station in the Western Ghats, Mahabaleshwar is a great destination for families looking for long stays. There are plenty of attractions and places in Mahabaleshwar that will keep your vacation afloat throughout the time you spend there.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/11/Mahabaleshwar_trip.jpg",
    images: [],
    major_tourist_attractions: [
      "Pratapgad Fort",
      "Venna Lake",
    ...
    best_things_to_do: [
      "Tour the several viewpoints",
      "boat at the lake",
      "explore the scenic waterfalls",
    ],
    ...
    places_to_eat: [
      ...
      "The Sizzler Place",
      "Farmhouse Bistro Restaurant",
    ],
    tips_to_remember:
      "Do travel to Mahabaleshwar by road as you will miss out on the lovely views.",
  },
  {
    id: "36",
    ...
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/10/Varanasi.jpg",
    images: [],
    major_tourist_attractions: [
    ...
    best_things_to_do: ["Visiting temples", "Ghats", "Ramnagar Fort"],
    best_time_to_visit: "October to March",
    how_to_reach:
      "There are direct flights and trains between Delhi and Varanasi.",
  ...
  },
  {
    ...
    descripton:
      "If Tirupati is there, Shirdi cannot be far behind too. The temple city attracts thousands of pilgrims each year and is a great destination for families to pray to the lord too. The city has many other attractions too which can be explored either over a weekend or a long weekend holiday!",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2020/01/Cover-Image-of-Hill-Stations-near-Shirdi-_21st-Jan.jpg",
    images: [],
    major_tourist_attractions: [
      "Dwarkamai",
      "Sai Heritage Village",
      "Sai Tirth Devotional Theme Park",
    ],
    best_things_to_do: [
      "Tour the religious places and spend time near the Godavari river",
    ],
    ...
    tips_to_remember:
      "The temple is crowded by devotees, make sure you keep a hold on your belongings",
  },
];
...
export const cold_places = [
  {
    ...
    descripton:
      "The much-celebrated heaven on earth, Srinagar is the jewel of Kashmir which happens to be the favorite destination of almost everyone in India. Rich in nature, hospitality, and experiences that blends well the amazing weather and the best places to visit in Srinagar, this bustling capital of Kashmir is the best place for a family trip in India.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/10/shutterstock_309339749.jpg",
    images: [],
    major_tourist_attractions: [
      "Dal Lake",
      "Shalimar Bagh",
      "Tulip Garden",
      " Pari Mahal and Chashme Shahi",
    ],
    best_things_to_do: [
      "Shikara ride at Dal Lake",
      "Visit the Hazratbal Shrine",
      "Explore the Hari Parbat",
    ],
    best_time_to_visit: "April to October",
    how_to_reach:
      " Major airlines like VIstara, AirAsia, Air India, SpiceJet have flights on Delhi-Srinagar route. You could also take a train from New Delhi to Jammu and make your way to Srinagar.",
    places_to_stay: [
      "Asian Park Hotel",
      "Vivanta Dal View",
...

  {
    ...
    descripton:
      "If you are looking for cheap family holiday destinations in India, then you could pick Manali in Himachal Pradesh. It is a beautiful resort town with quite a lot of attractions. The city has activities for both adults and kids. Solang Valley is one major attraction where one can indulge in adventure sports. Try parasailing on your next visit to Manali. One can book a stay at Mall Road there for an easier commute to the attraction points in the city.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/01/shutterstock_693251473.jpg",
    images: [],
    major_tourist_attractions: [
      "Solang Valley",
      "Hidimba Devi Temple",
    ...
    best_things_to_do: [
      "Trying adventure activities",
      " Strolling on Mall Road",
    ],
    best_time_to_visit: " October to February",
    how_to_reach:
      " There are overnight volvo buses from Delhi to Manali. Choose a bus that leaves early as jams near Bhuntar are bad. You will end up wasting your time stuck on the road.",
    places_to_stay: [
    ...
    places_to_eat: [
      `The Johnson’s Cafe & Hotel`,
      "Cafe 1947",
      "Drifter’s Cafe",
    ],
    tips_to_remember:
      "Try to carry less cash as there are ATM available at the Mall road",
  },
  {
    id: "41",
    name: "Ladakh, Kashmir",
    descripton:
      "Though this offbeat gem does not seem ideal to be counted in one of the best family holiday destinations in India, many families have broken this stereotypical perception by exploring the best of Ladakh in winter. Ladakh seems every bit of a paradise in winters wherein families can make the most of the tourist attractions like that of Shanti Stupa, Leh Palace, and Nubra Valley.",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2017/10/shutterstock_474367531.jpg",
    images: [],
    major_tourist_attractions: [
      "Shanti Stupa",
      "Tso Moriri Lake",
      ...
      "Nubra Valley",
      "Namgyal Tsemo Gompa",
      "Hall of Fame Museum and Spituk Monastery",
    ],
    best_things_to_do: [
      "Camping near Pangong Lake",
      "Explore the Himalayan views",
      "White water rafting in Zanskar River and Drive up till the Magnetic Hill",
    ],
    best_time_to_visit: "June to September",
    how_to_reach:
      "The best way to reach Leh is by air. If you are feeling more adventurous, then you could also plan a road trip. However, you would require a permit for that. Also, road journey is dependent on the weather conditions.",
    places_to_stay: [
  ...
  },
  {
    ...
    best_time_to_visit: "March to June",
    how_to_reach:
      "The best way to reach Spiti Valley is by taking the flight to Kullu airport. From there one can either board a bus, hire a taxi, or a private car to cover the remaining distance between the two.",
    ...
    tips_to_remember:
      "Avoid drinking alcohol as it may cause serious respiratory problems",
  },
  {
    id: "43",
    name: "Auli, Uttarakhand",
    descripton:
      "Tagged as the skiing destination of the country, Auli is one of the most stunning places for family trips in India. With numerous apple orchards covering its floors, towering pine trees forming the canopies, and the never-ending natural wonders swaying, Auli is a destination like no other. This hill resort is full of shimmering slopes and the cleanest environment one has ever witnessed. These slopes are exactly what makes Auli popular as a skiing destination and thus appealing to more and more travelers every year. Auli is one of the best travel destinations in India for family and has a lot to offer!",
    main_image:
      "https://img.traveltriangle.com/blog/wp-content/tr:w-700,h-400/uploads/2019/11/Auli-cover_27th-Nov.jpg",
    images: [],
    major_tourist_attractions: [
      "Gorson Bugyal",
      "Chenab Lake",
    ...
    best_things_to_do: [
      "Try Auli Ropeway",
      "shopping",
      "hiking till Nanda Devi",
      "trying skiing",
    ],
    best_time_to_visit: "November to March",
    how_to_reach:
      "The best way to reach Auli is by taking a bus from Delhi to Rishikesh. There are direct overnight buses easily available from Delhi. From there, one can hire a cab and cover the remaining distance.",
    places_to_stay: ["Giriganga Resort", "The Apple Farm Stay", "Zostel Homes"],
    famous_food: [
      " Different variety of dals",
      "leafy vegetables",
      "rice",
      "Kachmauli",
      "Bal Mithai",
...
const mainArr = [...warm_palces,...beech_city,...heritage_city,...national_parks,...holy_places,...natural_city,...cold_places];

export const findCity=(imgId)=>{
  let arr = mainArr.filter((city)=>city.id==imgId);
  return arr[0];
};
